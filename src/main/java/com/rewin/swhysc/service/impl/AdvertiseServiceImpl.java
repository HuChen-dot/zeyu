...
import com.rewin.swhysc.service.AdvertiseService;
...
public class AdvertiseServiceImpl implements AdvertiseService {
     ...
     */
    public PageInfo<Advertise> queryAdvertisePageByMap(Map<String, Object> param, Integer pageNo, Integer pageSize) throws Exception {
        //设置分页的起始页数和页面容量
        ...
        PageInfo<Advertise> info = new PageInfo<Advertise>();
